...
public interface AdditiveExpression extends SingleExpression {
    ...
    @Relation("HAS_PLUS")
    TerminalNodeStrings getPlus();

    void setPlus(TerminalNodeStrings setPlus);

    @Relation("HAS_MINUS")
    TerminalNodeStrings getMinus();

    void setMinus(TerminalNodeStrings setMinus);
}
