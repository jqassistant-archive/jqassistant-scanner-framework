...
public interface PreIncrementExpression extends SingleExpression {

    @Relation("HAS_PLUS_PLUS")
    TerminalNodeStrings getPlusPlus();

    void setPlusPlus(TerminalNodeStrings setPlusPlus);
