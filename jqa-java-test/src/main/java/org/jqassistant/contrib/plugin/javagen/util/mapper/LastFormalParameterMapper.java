...
import org.jqassistant.contrib.plugin.javagen.api.model.LastFormalParameter;
...
public interface LastFormalParameterMapper {

    public static LastFormalParameterMapper INSTANCE = Mappers.getMapper(LastFormalParameterMapper.class);
