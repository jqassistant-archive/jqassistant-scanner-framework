...
import org.jqassistant.contrib.plugin.javagen.api.model.ContinueStatement;
...
public interface ContinueStatementMapper {
    ...
    public static ContinueStatementMapper INSTANCE = Mappers.getMapper(ContinueStatementMapper.class);
