...
import org.jqassistant.contrib.plugin.javagen.api.model.UnaryExpression;
...
public interface UnaryExpressionMapper {
    ...
    public static UnaryExpressionMapper INSTANCE = Mappers.getMapper(UnaryExpressionMapper.class);
