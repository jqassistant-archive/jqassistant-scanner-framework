...
import org.jqassistant.contrib.plugin.javagen.api.model.AnnotationTypeMemberDeclaration;
...
public interface AnnotationTypeMemberDeclarationMapper {

    public static AnnotationTypeMemberDeclarationMapper INSTANCE = Mappers.getMapper(AnnotationTypeMemberDeclarationMapper.class);
