...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumConstant;
...
public interface EnumConstantMapper {
    ...
    public static EnumConstantMapper INSTANCE = Mappers.getMapper(EnumConstantMapper.class);
