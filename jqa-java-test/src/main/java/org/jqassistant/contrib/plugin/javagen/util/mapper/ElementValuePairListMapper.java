...
import org.jqassistant.contrib.plugin.javagen.api.model.ElementValuePairList;
...
public interface ElementValuePairListMapper {

    public static ElementValuePairListMapper INSTANCE = Mappers.getMapper(ElementValuePairListMapper.class);
