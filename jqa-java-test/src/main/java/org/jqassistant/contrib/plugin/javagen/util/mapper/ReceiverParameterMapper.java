...
import org.jqassistant.contrib.plugin.javagen.api.model.ReceiverParameter;
...
public interface ReceiverParameterMapper {

    public static ReceiverParameterMapper INSTANCE = Mappers.getMapper(ReceiverParameterMapper.class);
