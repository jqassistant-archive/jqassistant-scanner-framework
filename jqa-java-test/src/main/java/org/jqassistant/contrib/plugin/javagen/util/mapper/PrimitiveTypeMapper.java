...
import org.jqassistant.contrib.plugin.javagen.api.model.PrimitiveType;
...
public interface PrimitiveTypeMapper {
    ...
    public static PrimitiveTypeMapper INSTANCE = Mappers.getMapper(PrimitiveTypeMapper.class);
