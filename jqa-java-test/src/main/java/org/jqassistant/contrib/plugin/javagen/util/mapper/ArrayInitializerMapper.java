...
import org.jqassistant.contrib.plugin.javagen.api.model.ArrayInitializer;
...
public interface ArrayInitializerMapper {

    public static ArrayInitializerMapper INSTANCE = Mappers.getMapper(ArrayInitializerMapper.class);
