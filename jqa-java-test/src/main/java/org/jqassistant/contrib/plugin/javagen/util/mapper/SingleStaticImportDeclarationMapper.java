...
import org.jqassistant.contrib.plugin.javagen.api.model.SingleStaticImportDeclaration;
...
public interface SingleStaticImportDeclarationMapper {

    public static SingleStaticImportDeclarationMapper INSTANCE = Mappers.getMapper(SingleStaticImportDeclarationMapper.class);
