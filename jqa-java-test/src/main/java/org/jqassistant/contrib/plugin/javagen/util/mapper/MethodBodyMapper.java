...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodBody;
...
public interface MethodBodyMapper {

    public static MethodBodyMapper INSTANCE = Mappers.getMapper(MethodBodyMapper.class);
