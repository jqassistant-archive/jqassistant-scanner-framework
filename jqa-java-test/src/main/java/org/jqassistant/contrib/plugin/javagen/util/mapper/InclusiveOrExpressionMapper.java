...
import org.jqassistant.contrib.plugin.javagen.api.model.InclusiveOrExpression;
...
public interface InclusiveOrExpressionMapper {

    public static InclusiveOrExpressionMapper INSTANCE = Mappers.getMapper(InclusiveOrExpressionMapper.class);
