...
import org.jqassistant.contrib.plugin.javagen.api.model.SingleTypeImportDeclaration;
...
public interface SingleTypeImportDeclarationMapper {

    public static SingleTypeImportDeclarationMapper INSTANCE = Mappers.getMapper(SingleTypeImportDeclarationMapper.class);
