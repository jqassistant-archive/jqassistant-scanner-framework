...
import org.jqassistant.contrib.plugin.javagen.api.model.LambdaBody;
...
public interface LambdaBodyMapper {

    public static LambdaBodyMapper INSTANCE = Mappers.getMapper(LambdaBodyMapper.class);
