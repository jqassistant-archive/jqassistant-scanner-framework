...
import org.jqassistant.contrib.plugin.javagen.api.model.ExceptionTypeList;
...
public interface ExceptionTypeListMapper {

    public static ExceptionTypeListMapper INSTANCE = Mappers.getMapper(ExceptionTypeListMapper.class);
