...
import org.jqassistant.contrib.plugin.javagen.api.model.ArrayAccess;
...
public interface ArrayAccessMapper {

    public static ArrayAccessMapper INSTANCE = Mappers.getMapper(ArrayAccessMapper.class);
