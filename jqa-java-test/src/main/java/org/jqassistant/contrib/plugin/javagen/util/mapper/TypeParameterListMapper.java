...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeParameterList;
...
public interface TypeParameterListMapper {

    public static TypeParameterListMapper INSTANCE = Mappers.getMapper(TypeParameterListMapper.class);
