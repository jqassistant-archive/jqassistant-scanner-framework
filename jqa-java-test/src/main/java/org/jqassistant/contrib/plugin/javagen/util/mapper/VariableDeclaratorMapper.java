...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableDeclarator;
...
public interface VariableDeclaratorMapper {

    public static VariableDeclaratorMapper INSTANCE = Mappers.getMapper(VariableDeclaratorMapper.class);
