...
import org.jqassistant.contrib.plugin.javagen.api.model.ElementValuePair;
...
public interface ElementValuePairMapper {

    public static ElementValuePairMapper INSTANCE = Mappers.getMapper(ElementValuePairMapper.class);
