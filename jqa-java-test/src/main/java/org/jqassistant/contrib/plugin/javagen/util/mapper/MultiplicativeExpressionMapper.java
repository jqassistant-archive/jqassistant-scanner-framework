...
import org.jqassistant.contrib.plugin.javagen.api.model.MultiplicativeExpression;
...
public interface MultiplicativeExpressionMapper {

    public static MultiplicativeExpressionMapper INSTANCE = Mappers.getMapper(MultiplicativeExpressionMapper.class);
