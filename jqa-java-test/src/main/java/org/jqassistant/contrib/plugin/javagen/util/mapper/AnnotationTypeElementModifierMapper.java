...
import org.jqassistant.contrib.plugin.javagen.api.model.AnnotationTypeElementModifier;
...
public interface AnnotationTypeElementModifierMapper {

    public static AnnotationTypeElementModifierMapper INSTANCE = Mappers.getMapper(AnnotationTypeElementModifierMapper.class);
