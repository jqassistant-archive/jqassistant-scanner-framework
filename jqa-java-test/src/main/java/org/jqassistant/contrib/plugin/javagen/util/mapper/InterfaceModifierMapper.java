...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceModifier;
...
public interface InterfaceModifierMapper {

    public static InterfaceModifierMapper INSTANCE = Mappers.getMapper(InterfaceModifierMapper.class);
