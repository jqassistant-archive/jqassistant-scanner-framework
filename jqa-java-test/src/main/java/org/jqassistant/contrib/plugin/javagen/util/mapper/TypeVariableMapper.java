...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeVariable;
...
public interface TypeVariableMapper {
    ...
    public static TypeVariableMapper INSTANCE = Mappers.getMapper(TypeVariableMapper.class);
