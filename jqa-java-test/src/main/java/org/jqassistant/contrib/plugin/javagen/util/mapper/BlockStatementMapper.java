...
import org.jqassistant.contrib.plugin.javagen.api.model.BlockStatement;
...
public interface BlockStatementMapper {
    ...
    public static BlockStatementMapper INSTANCE = Mappers.getMapper(BlockStatementMapper.class);
