...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodModifier;
...
public interface MethodModifierMapper {

    public static MethodModifierMapper INSTANCE = Mappers.getMapper(MethodModifierMapper.class);
