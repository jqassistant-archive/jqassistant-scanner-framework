...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeParameterModifier;
...
public interface TypeParameterModifierMapper {

    public static TypeParameterModifierMapper INSTANCE = Mappers.getMapper(TypeParameterModifierMapper.class);
