...
import org.jqassistant.contrib.plugin.javagen.api.model.MarkerAnnotation;
...
public interface MarkerAnnotationMapper {

    public static MarkerAnnotationMapper INSTANCE = Mappers.getMapper(MarkerAnnotationMapper.class);
