...
import org.jqassistant.contrib.plugin.javagen.api.model.IfThenElseStatementNoShortIf;
...
public interface IfThenElseStatementNoShortIfMapper {

    public static IfThenElseStatementNoShortIfMapper INSTANCE = Mappers.getMapper(IfThenElseStatementNoShortIfMapper.class);
