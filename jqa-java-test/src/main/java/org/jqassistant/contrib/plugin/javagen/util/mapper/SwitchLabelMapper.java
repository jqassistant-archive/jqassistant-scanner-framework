...
import org.jqassistant.contrib.plugin.javagen.api.model.SwitchLabel;
...
public interface SwitchLabelMapper {

    public static SwitchLabelMapper INSTANCE = Mappers.getMapper(SwitchLabelMapper.class);
