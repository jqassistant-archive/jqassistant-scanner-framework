...
import org.jqassistant.contrib.plugin.javagen.api.model.ClassMemberDeclaration;
...
public interface ClassMemberDeclarationMapper {

    public static ClassMemberDeclarationMapper INSTANCE = Mappers.getMapper(ClassMemberDeclarationMapper.class);
