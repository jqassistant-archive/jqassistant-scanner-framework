...
import org.jqassistant.contrib.plugin.javagen.api.model.CastExpression;
...
public interface CastExpressionMapper {

    public static CastExpressionMapper INSTANCE = Mappers.getMapper(CastExpressionMapper.class);
