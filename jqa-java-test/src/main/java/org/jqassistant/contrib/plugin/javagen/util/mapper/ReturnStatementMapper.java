...
import org.jqassistant.contrib.plugin.javagen.api.model.ReturnStatement;
...
public interface ReturnStatementMapper {
    ...
    public static ReturnStatementMapper INSTANCE = Mappers.getMapper(ReturnStatementMapper.class);
