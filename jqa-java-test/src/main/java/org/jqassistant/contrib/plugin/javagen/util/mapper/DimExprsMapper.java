...
import org.jqassistant.contrib.plugin.javagen.api.model.DimExprs;
...
public interface DimExprsMapper {

    public static DimExprsMapper INSTANCE = Mappers.getMapper(DimExprsMapper.class);
