...
import org.jqassistant.contrib.plugin.javagen.api.model.PrimaryNoNewArray;
...
public interface PrimaryNoNewArrayMapper {

    public static PrimaryNoNewArrayMapper INSTANCE = Mappers.getMapper(PrimaryNoNewArrayMapper.class);
