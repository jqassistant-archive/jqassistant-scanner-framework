...
import org.jqassistant.contrib.plugin.javagen.api.model.EqualityExpression;
...
public interface EqualityExpressionMapper {

    public static EqualityExpressionMapper INSTANCE = Mappers.getMapper(EqualityExpressionMapper.class);
