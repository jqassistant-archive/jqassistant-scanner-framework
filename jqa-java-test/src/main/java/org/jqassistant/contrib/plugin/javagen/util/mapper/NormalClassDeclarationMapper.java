...
import org.jqassistant.contrib.plugin.javagen.api.model.NormalClassDeclaration;
...
public interface NormalClassDeclarationMapper {

    public static NormalClassDeclarationMapper INSTANCE = Mappers.getMapper(NormalClassDeclarationMapper.class);
