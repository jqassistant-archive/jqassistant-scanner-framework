...
import org.jqassistant.contrib.plugin.javagen.api.model.FormalParameterList;
...
public interface FormalParameterListMapper {

    public static FormalParameterListMapper INSTANCE = Mappers.getMapper(FormalParameterListMapper.class);
