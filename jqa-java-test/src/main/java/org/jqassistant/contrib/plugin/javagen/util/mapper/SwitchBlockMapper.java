...
import org.jqassistant.contrib.plugin.javagen.api.model.SwitchBlock;
...
public interface SwitchBlockMapper {

    public static SwitchBlockMapper INSTANCE = Mappers.getMapper(SwitchBlockMapper.class);
