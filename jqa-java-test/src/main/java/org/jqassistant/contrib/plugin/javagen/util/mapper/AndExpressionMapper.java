...
import org.jqassistant.contrib.plugin.javagen.api.model.AndExpression;
...
public interface AndExpressionMapper {

    public static AndExpressionMapper INSTANCE = Mappers.getMapper(AndExpressionMapper.class);
