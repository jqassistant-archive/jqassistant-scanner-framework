...
import org.jqassistant.contrib.plugin.javagen.api.model.LambdaParameters;
...
public interface LambdaParametersMapper {

    public static LambdaParametersMapper INSTANCE = Mappers.getMapper(LambdaParametersMapper.class);
