...
import org.jqassistant.contrib.plugin.javagen.api.model.CatchFormalParameter;
...
public interface CatchFormalParameterMapper {

    public static CatchFormalParameterMapper INSTANCE = Mappers.getMapper(CatchFormalParameterMapper.class);
