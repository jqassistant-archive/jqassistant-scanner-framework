...
import org.jqassistant.contrib.plugin.javagen.api.model.StatementWithoutTrailingSubstatement;
...
public interface StatementWithoutTrailingSubstatementMapper {

    public static StatementWithoutTrailingSubstatementMapper INSTANCE = Mappers.getMapper(StatementWithoutTrailingSubstatementMapper.class);
