...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumConstantName;
...
public interface EnumConstantNameMapper {

    public static EnumConstantNameMapper INSTANCE = Mappers.getMapper(EnumConstantNameMapper.class);
