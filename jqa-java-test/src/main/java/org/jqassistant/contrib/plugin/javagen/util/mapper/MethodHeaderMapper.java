...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodHeader;
...
public interface MethodHeaderMapper {

    public static MethodHeaderMapper INSTANCE = Mappers.getMapper(MethodHeaderMapper.class);
