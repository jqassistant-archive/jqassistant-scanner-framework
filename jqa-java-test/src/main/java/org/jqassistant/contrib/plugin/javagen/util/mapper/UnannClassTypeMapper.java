...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannClassType;
...
public interface UnannClassTypeMapper {

    public static UnannClassTypeMapper INSTANCE = Mappers.getMapper(UnannClassTypeMapper.class);
