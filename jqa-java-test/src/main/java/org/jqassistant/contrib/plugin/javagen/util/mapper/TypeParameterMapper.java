...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeParameter;
...
public interface TypeParameterMapper {
    ...
    public static TypeParameterMapper INSTANCE = Mappers.getMapper(TypeParameterMapper.class);
