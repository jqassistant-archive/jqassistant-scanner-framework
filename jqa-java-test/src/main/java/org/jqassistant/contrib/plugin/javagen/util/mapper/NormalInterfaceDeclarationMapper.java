...
import org.jqassistant.contrib.plugin.javagen.api.model.NormalInterfaceDeclaration;
...
public interface NormalInterfaceDeclarationMapper {

    public static NormalInterfaceDeclarationMapper INSTANCE = Mappers.getMapper(NormalInterfaceDeclarationMapper.class);
