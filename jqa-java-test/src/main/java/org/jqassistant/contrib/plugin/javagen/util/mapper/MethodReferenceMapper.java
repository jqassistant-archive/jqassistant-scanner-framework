...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodReference;
...
public interface MethodReferenceMapper {

    public static MethodReferenceMapper INSTANCE = Mappers.getMapper(MethodReferenceMapper.class);
