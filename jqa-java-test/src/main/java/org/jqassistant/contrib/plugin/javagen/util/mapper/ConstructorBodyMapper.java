...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstructorBody;
...
public interface ConstructorBodyMapper {

    public static ConstructorBodyMapper INSTANCE = Mappers.getMapper(ConstructorBodyMapper.class);
