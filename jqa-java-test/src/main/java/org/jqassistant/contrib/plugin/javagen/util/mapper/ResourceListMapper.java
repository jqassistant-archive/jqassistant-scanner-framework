...
import org.jqassistant.contrib.plugin.javagen.api.model.ResourceList;
...
public interface ResourceListMapper {
    ...
    public static ResourceListMapper INSTANCE = Mappers.getMapper(ResourceListMapper.class);
