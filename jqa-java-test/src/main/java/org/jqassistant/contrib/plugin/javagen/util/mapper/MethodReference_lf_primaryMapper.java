...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodReference_lf_primary;
...
public interface MethodReference_lf_primaryMapper {

    public static MethodReference_lf_primaryMapper INSTANCE = Mappers.getMapper(MethodReference_lf_primaryMapper.class);
