...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannInterfaceType;
...
public interface UnannInterfaceTypeMapper {

    public static UnannInterfaceTypeMapper INSTANCE = Mappers.getMapper(UnannInterfaceTypeMapper.class);
