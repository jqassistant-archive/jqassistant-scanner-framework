...
import org.jqassistant.contrib.plugin.javagen.api.model.BreakStatement;
...
public interface BreakStatementMapper {
    ...
    public static BreakStatementMapper INSTANCE = Mappers.getMapper(BreakStatementMapper.class);
