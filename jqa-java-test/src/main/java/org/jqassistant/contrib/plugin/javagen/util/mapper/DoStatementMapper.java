...
import org.jqassistant.contrib.plugin.javagen.api.model.DoStatement;
...
public interface DoStatementMapper {

    public static DoStatementMapper INSTANCE = Mappers.getMapper(DoStatementMapper.class);
