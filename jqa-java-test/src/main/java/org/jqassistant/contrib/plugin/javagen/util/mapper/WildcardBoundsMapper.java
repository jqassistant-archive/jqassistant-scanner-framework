...
import org.jqassistant.contrib.plugin.javagen.api.model.WildcardBounds;
...
public interface WildcardBoundsMapper {

    public static WildcardBoundsMapper INSTANCE = Mappers.getMapper(WildcardBoundsMapper.class);
