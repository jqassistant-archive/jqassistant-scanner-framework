...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannClassOrInterfaceType;
...
public interface UnannClassOrInterfaceTypeMapper {

    public static UnannClassOrInterfaceTypeMapper INSTANCE = Mappers.getMapper(UnannClassOrInterfaceTypeMapper.class);
