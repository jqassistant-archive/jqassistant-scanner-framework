...
import org.jqassistant.contrib.plugin.javagen.api.model.AdditionalBound;
...
public interface AdditionalBoundMapper {

    public static AdditionalBoundMapper INSTANCE = Mappers.getMapper(AdditionalBoundMapper.class);
