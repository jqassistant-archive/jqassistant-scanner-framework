...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodDeclarator;
...
public interface MethodDeclaratorMapper {

    public static MethodDeclaratorMapper INSTANCE = Mappers.getMapper(MethodDeclaratorMapper.class);
