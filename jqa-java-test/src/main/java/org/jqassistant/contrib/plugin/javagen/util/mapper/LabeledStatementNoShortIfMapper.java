...
import org.jqassistant.contrib.plugin.javagen.api.model.LabeledStatementNoShortIf;
...
public interface LabeledStatementNoShortIfMapper {

    public static LabeledStatementNoShortIfMapper INSTANCE = Mappers.getMapper(LabeledStatementNoShortIfMapper.class);
