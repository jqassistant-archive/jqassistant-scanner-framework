...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumBody;
...
public interface EnumBodyMapper {

    public static EnumBodyMapper INSTANCE = Mappers.getMapper(EnumBodyMapper.class);
