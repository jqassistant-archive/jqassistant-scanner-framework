...
import org.jqassistant.contrib.plugin.javagen.api.model.AdditiveExpression;
...
public interface AdditiveExpressionMapper {

    public static AdditiveExpressionMapper INSTANCE = Mappers.getMapper(AdditiveExpressionMapper.class);
