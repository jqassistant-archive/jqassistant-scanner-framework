...
import org.jqassistant.contrib.plugin.javagen.api.model.IfThenStatement;
...
public interface IfThenStatementMapper {

    public static IfThenStatementMapper INSTANCE = Mappers.getMapper(IfThenStatementMapper.class);
