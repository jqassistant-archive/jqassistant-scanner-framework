...
import org.jqassistant.contrib.plugin.javagen.api.model.FieldModifier;
...
public interface FieldModifierMapper {

    public static FieldModifierMapper INSTANCE = Mappers.getMapper(FieldModifierMapper.class);
