...
import org.jqassistant.contrib.plugin.javagen.api.model.FloatingPointType;
...
public interface FloatingPointTypeMapper {

    public static FloatingPointTypeMapper INSTANCE = Mappers.getMapper(FloatingPointTypeMapper.class);
