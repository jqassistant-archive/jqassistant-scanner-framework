...
import org.jqassistant.contrib.plugin.javagen.api.model.ForStatement;
...
public interface ForStatementMapper {
    ...
    public static ForStatementMapper INSTANCE = Mappers.getMapper(ForStatementMapper.class);
