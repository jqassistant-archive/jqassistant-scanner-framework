...
import org.jqassistant.contrib.plugin.javagen.api.model.PostIncrementExpression;
...
public interface PostIncrementExpressionMapper {

    public static PostIncrementExpressionMapper INSTANCE = Mappers.getMapper(PostIncrementExpressionMapper.class);
