...
import org.jqassistant.contrib.plugin.javagen.api.model.AssertStatement;
...
public interface AssertStatementMapper {
    ...
    public static AssertStatementMapper INSTANCE = Mappers.getMapper(AssertStatementMapper.class);
