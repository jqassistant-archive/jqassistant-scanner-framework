...
import org.jqassistant.contrib.plugin.javagen.api.model.ClassOrInterfaceType;
...
public interface ClassOrInterfaceTypeMapper {

    public static ClassOrInterfaceTypeMapper INSTANCE = Mappers.getMapper(ClassOrInterfaceTypeMapper.class);
