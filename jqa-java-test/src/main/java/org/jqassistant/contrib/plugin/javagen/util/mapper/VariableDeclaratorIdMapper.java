...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableDeclaratorId;
...
public interface VariableDeclaratorIdMapper {

    public static VariableDeclaratorIdMapper INSTANCE = Mappers.getMapper(VariableDeclaratorIdMapper.class);
