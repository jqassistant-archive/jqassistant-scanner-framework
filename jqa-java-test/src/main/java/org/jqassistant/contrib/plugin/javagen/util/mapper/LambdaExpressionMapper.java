...
import org.jqassistant.contrib.plugin.javagen.api.model.LambdaExpression;
...
public interface LambdaExpressionMapper {
    ...
    public static LambdaExpressionMapper INSTANCE = Mappers.getMapper(LambdaExpressionMapper.class);
