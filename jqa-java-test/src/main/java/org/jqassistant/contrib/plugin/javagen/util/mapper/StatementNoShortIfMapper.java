...
import org.jqassistant.contrib.plugin.javagen.api.model.StatementNoShortIf;
...
public interface StatementNoShortIfMapper {

    public static StatementNoShortIfMapper INSTANCE = Mappers.getMapper(StatementNoShortIfMapper.class);
