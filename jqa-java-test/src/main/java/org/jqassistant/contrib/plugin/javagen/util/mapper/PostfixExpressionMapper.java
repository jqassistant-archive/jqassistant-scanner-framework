...
import org.jqassistant.contrib.plugin.javagen.api.model.PostfixExpression;
...
public interface PostfixExpressionMapper {

    public static PostfixExpressionMapper INSTANCE = Mappers.getMapper(PostfixExpressionMapper.class);
