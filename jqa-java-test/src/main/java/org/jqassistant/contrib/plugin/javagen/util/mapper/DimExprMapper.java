...
import org.jqassistant.contrib.plugin.javagen.api.model.DimExpr;
...
public interface DimExprMapper {

    public static DimExprMapper INSTANCE = Mappers.getMapper(DimExprMapper.class);
