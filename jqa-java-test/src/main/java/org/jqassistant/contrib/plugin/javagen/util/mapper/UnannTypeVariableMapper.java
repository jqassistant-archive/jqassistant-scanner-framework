...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannTypeVariable;
...
public interface UnannTypeVariableMapper {

    public static UnannTypeVariableMapper INSTANCE = Mappers.getMapper(UnannTypeVariableMapper.class);
