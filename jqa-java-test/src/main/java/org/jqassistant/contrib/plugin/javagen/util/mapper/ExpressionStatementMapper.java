...
import org.jqassistant.contrib.plugin.javagen.api.model.ExpressionStatement;
...
public interface ExpressionStatementMapper {
    ...
    public static ExpressionStatementMapper INSTANCE = Mappers.getMapper(ExpressionStatementMapper.class);
