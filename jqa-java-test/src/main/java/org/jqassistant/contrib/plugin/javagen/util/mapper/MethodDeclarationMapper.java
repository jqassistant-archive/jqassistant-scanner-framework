...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodDeclaration;
...
public interface MethodDeclarationMapper {

    public static MethodDeclarationMapper INSTANCE = Mappers.getMapper(MethodDeclarationMapper.class);
