...
import org.jqassistant.contrib.plugin.javagen.api.model.AssignmentExpression;
...
public interface AssignmentExpressionMapper {
    ...
    public static AssignmentExpressionMapper INSTANCE = Mappers.getMapper(AssignmentExpressionMapper.class);
