...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableInitializerList;
...
public interface VariableInitializerListMapper {

    public static VariableInitializerListMapper INSTANCE = Mappers.getMapper(VariableInitializerListMapper.class);
