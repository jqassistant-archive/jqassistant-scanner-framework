...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeImportOnDemandDeclaration;
...
public interface TypeImportOnDemandDeclarationMapper {

    public static TypeImportOnDemandDeclarationMapper INSTANCE = Mappers.getMapper(TypeImportOnDemandDeclarationMapper.class);
