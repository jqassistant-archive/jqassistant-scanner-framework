...
import org.jqassistant.contrib.plugin.javagen.api.model.ConditionalOrExpression;
...
public interface ConditionalOrExpressionMapper {

    public static ConditionalOrExpressionMapper INSTANCE = Mappers.getMapper(ConditionalOrExpressionMapper.class);
