...
import org.jqassistant.contrib.plugin.javagen.api.model.AssignmentOperator;
...
public interface AssignmentOperatorMapper {

    public static AssignmentOperatorMapper INSTANCE = Mappers.getMapper(AssignmentOperatorMapper.class);
