...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeArguments;
...
public interface TypeArgumentsMapper {

    public static TypeArgumentsMapper INSTANCE = Mappers.getMapper(TypeArgumentsMapper.class);
