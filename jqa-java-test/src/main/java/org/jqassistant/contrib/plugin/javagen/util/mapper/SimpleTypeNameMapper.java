...
import org.jqassistant.contrib.plugin.javagen.api.model.SimpleTypeName;
...
public interface SimpleTypeNameMapper {

    public static SimpleTypeNameMapper INSTANCE = Mappers.getMapper(SimpleTypeNameMapper.class);
