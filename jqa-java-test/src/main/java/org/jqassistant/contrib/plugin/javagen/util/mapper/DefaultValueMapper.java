...
import org.jqassistant.contrib.plugin.javagen.api.model.DefaultValue;
...
public interface DefaultValueMapper {
    ...
    public static DefaultValueMapper INSTANCE = Mappers.getMapper(DefaultValueMapper.class);
