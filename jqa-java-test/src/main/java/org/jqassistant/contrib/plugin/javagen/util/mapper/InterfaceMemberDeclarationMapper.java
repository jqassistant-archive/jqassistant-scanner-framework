...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceMemberDeclaration;
...
public interface InterfaceMemberDeclarationMapper {

    public static InterfaceMemberDeclarationMapper INSTANCE = Mappers.getMapper(InterfaceMemberDeclarationMapper.class);
