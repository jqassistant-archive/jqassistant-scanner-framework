...
import org.jqassistant.contrib.plugin.javagen.api.model.SingleElementAnnotation;
...
public interface SingleElementAnnotationMapper {

    public static SingleElementAnnotationMapper INSTANCE = Mappers.getMapper(SingleElementAnnotationMapper.class);
