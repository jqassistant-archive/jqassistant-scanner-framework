...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeArgumentList;
...
public interface TypeArgumentListMapper {

    public static TypeArgumentListMapper INSTANCE = Mappers.getMapper(TypeArgumentListMapper.class);
