...
import org.jqassistant.contrib.plugin.javagen.api.model.ExpressionName;
...
public interface ExpressionNameMapper {

    public static ExpressionNameMapper INSTANCE = Mappers.getMapper(ExpressionNameMapper.class);
