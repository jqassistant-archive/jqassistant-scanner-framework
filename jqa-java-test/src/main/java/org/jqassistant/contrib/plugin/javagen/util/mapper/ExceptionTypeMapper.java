...
import org.jqassistant.contrib.plugin.javagen.api.model.ExceptionType;
...
public interface ExceptionTypeMapper {
    ...
    public static ExceptionTypeMapper INSTANCE = Mappers.getMapper(ExceptionTypeMapper.class);
