...
import org.jqassistant.contrib.plugin.javagen.api.model.ShiftExpression;
...
public interface ShiftExpressionMapper {

    public static ShiftExpressionMapper INSTANCE = Mappers.getMapper(ShiftExpressionMapper.class);
