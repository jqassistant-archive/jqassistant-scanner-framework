...
import org.jqassistant.contrib.plugin.javagen.api.model.ExplicitConstructorInvocation;
...
public interface ExplicitConstructorInvocationMapper {

    public static ExplicitConstructorInvocationMapper INSTANCE = Mappers.getMapper(ExplicitConstructorInvocationMapper.class);
