...
import org.jqassistant.contrib.plugin.javagen.api.model.ImportDeclaration;
...
public interface ImportDeclarationMapper {
    ...
    public static ImportDeclarationMapper INSTANCE = Mappers.getMapper(ImportDeclarationMapper.class);
