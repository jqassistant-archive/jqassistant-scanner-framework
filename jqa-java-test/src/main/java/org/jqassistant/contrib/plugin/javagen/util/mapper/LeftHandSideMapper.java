...
import org.jqassistant.contrib.plugin.javagen.api.model.LeftHandSide;
...
public interface LeftHandSideMapper {

    public static LeftHandSideMapper INSTANCE = Mappers.getMapper(LeftHandSideMapper.class);
