...
import org.jqassistant.contrib.plugin.javagen.api.model.Throws_;
...
public interface Throws_Mapper {

    public static Throws_Mapper INSTANCE = Mappers.getMapper(Throws_Mapper.class);
