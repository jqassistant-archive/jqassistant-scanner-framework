...
import org.jqassistant.contrib.plugin.javagen.api.model.StatementExpressionList;
...
public interface StatementExpressionListMapper {

    public static StatementExpressionListMapper INSTANCE = Mappers.getMapper(StatementExpressionListMapper.class);
