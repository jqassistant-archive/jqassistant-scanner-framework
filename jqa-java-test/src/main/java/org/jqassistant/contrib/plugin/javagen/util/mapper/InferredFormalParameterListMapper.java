...
import org.jqassistant.contrib.plugin.javagen.api.model.InferredFormalParameterList;
...
public interface InferredFormalParameterListMapper {

    public static InferredFormalParameterListMapper INSTANCE = Mappers.getMapper(InferredFormalParameterListMapper.class);
