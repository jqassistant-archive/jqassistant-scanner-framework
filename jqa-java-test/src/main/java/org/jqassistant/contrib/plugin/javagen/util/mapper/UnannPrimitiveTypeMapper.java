...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannPrimitiveType;
...
public interface UnannPrimitiveTypeMapper {

    public static UnannPrimitiveTypeMapper INSTANCE = Mappers.getMapper(UnannPrimitiveTypeMapper.class);
