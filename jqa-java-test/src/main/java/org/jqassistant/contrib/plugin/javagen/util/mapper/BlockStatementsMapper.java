...
import org.jqassistant.contrib.plugin.javagen.api.model.BlockStatements;
...
public interface BlockStatementsMapper {

    public static BlockStatementsMapper INSTANCE = Mappers.getMapper(BlockStatementsMapper.class);
