...
import org.jqassistant.contrib.plugin.javagen.api.model.CatchType;
...
public interface CatchTypeMapper {

    public static CatchTypeMapper INSTANCE = Mappers.getMapper(CatchTypeMapper.class);
