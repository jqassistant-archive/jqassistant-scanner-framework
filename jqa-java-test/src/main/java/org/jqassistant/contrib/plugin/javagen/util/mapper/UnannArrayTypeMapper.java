...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannArrayType;
...
public interface UnannArrayTypeMapper {

    public static UnannArrayTypeMapper INSTANCE = Mappers.getMapper(UnannArrayTypeMapper.class);
