...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannReferenceType;
...
public interface UnannReferenceTypeMapper {

    public static UnannReferenceTypeMapper INSTANCE = Mappers.getMapper(UnannReferenceTypeMapper.class);
