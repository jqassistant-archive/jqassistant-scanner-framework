...
import org.jqassistant.contrib.plugin.javagen.api.model.ForInit;
...
public interface ForInitMapper {

    public static ForInitMapper INSTANCE = Mappers.getMapper(ForInitMapper.class);
