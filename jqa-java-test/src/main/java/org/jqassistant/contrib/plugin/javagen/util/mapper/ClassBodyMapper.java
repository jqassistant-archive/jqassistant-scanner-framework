...
import org.jqassistant.contrib.plugin.javagen.api.model.ClassBody;
...
public interface ClassBodyMapper {

    public static ClassBodyMapper INSTANCE = Mappers.getMapper(ClassBodyMapper.class);
