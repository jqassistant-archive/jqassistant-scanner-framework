...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstantExpression;
...
public interface ConstantExpressionMapper {

    public static ConstantExpressionMapper INSTANCE = Mappers.getMapper(ConstantExpressionMapper.class);
