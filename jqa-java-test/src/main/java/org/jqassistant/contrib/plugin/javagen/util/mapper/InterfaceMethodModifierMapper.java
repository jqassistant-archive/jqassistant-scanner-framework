...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceMethodModifier;
...
public interface InterfaceMethodModifierMapper {

    public static InterfaceMethodModifierMapper INSTANCE = Mappers.getMapper(InterfaceMethodModifierMapper.class);
