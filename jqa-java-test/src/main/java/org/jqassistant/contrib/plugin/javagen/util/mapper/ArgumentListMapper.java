...
import org.jqassistant.contrib.plugin.javagen.api.model.ArgumentList;
...
public interface ArgumentListMapper {

    public static ArgumentListMapper INSTANCE = Mappers.getMapper(ArgumentListMapper.class);
