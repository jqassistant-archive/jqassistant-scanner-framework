...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceMethodDeclaration;
...
public interface InterfaceMethodDeclarationMapper {

    public static InterfaceMethodDeclarationMapper INSTANCE = Mappers.getMapper(InterfaceMethodDeclarationMapper.class);
