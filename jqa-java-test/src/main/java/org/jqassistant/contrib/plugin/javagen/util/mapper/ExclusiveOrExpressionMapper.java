...
import org.jqassistant.contrib.plugin.javagen.api.model.ExclusiveOrExpression;
...
public interface ExclusiveOrExpressionMapper {

    public static ExclusiveOrExpressionMapper INSTANCE = Mappers.getMapper(ExclusiveOrExpressionMapper.class);
