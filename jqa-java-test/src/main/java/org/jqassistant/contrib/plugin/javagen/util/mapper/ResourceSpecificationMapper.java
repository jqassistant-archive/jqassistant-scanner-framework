...
import org.jqassistant.contrib.plugin.javagen.api.model.ResourceSpecification;
...
public interface ResourceSpecificationMapper {
    ...
    public static ResourceSpecificationMapper INSTANCE = Mappers.getMapper(ResourceSpecificationMapper.class);
