...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstantModifier;
...
public interface ConstantModifierMapper {

    public static ConstantModifierMapper INSTANCE = Mappers.getMapper(ConstantModifierMapper.class);
