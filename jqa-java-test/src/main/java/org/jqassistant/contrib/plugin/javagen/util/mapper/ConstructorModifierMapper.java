...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstructorModifier;
...
public interface ConstructorModifierMapper {

    public static ConstructorModifierMapper INSTANCE = Mappers.getMapper(ConstructorModifierMapper.class);
