...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeParameters;
...
public interface TypeParametersMapper {

    public static TypeParametersMapper INSTANCE = Mappers.getMapper(TypeParametersMapper.class);
