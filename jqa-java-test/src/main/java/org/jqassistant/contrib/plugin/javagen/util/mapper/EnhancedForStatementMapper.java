...
import org.jqassistant.contrib.plugin.javagen.api.model.EnhancedForStatement;
...
public interface EnhancedForStatementMapper {

    public static EnhancedForStatementMapper INSTANCE = Mappers.getMapper(EnhancedForStatementMapper.class);
