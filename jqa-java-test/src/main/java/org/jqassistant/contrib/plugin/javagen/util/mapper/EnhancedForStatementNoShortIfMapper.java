...
import org.jqassistant.contrib.plugin.javagen.api.model.EnhancedForStatementNoShortIf;
...
public interface EnhancedForStatementNoShortIfMapper {

    public static EnhancedForStatementNoShortIfMapper INSTANCE = Mappers.getMapper(EnhancedForStatementNoShortIfMapper.class);
