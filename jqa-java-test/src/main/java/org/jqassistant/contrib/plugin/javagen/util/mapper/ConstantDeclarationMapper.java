...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstantDeclaration;
...
public interface ConstantDeclarationMapper {

    public static ConstantDeclarationMapper INSTANCE = Mappers.getMapper(ConstantDeclarationMapper.class);
