...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableDeclaratorList;
...
public interface VariableDeclaratorListMapper {

    public static VariableDeclaratorListMapper INSTANCE = Mappers.getMapper(VariableDeclaratorListMapper.class);
