...
import org.jqassistant.contrib.plugin.javagen.api.model.SwitchStatement;
...
public interface SwitchStatementMapper {
    ...
    public static SwitchStatementMapper INSTANCE = Mappers.getMapper(SwitchStatementMapper.class);
