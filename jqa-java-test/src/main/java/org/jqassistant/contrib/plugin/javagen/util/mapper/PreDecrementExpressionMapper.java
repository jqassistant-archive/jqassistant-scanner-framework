...
import org.jqassistant.contrib.plugin.javagen.api.model.PreDecrementExpression;
...
public interface PreDecrementExpressionMapper {

    public static PreDecrementExpressionMapper INSTANCE = Mappers.getMapper(PreDecrementExpressionMapper.class);
