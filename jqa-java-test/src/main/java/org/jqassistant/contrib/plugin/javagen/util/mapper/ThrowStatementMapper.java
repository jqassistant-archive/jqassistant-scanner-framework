...
import org.jqassistant.contrib.plugin.javagen.api.model.ThrowStatement;
...
public interface ThrowStatementMapper {
    ...
    public static ThrowStatementMapper INSTANCE = Mappers.getMapper(ThrowStatementMapper.class);
