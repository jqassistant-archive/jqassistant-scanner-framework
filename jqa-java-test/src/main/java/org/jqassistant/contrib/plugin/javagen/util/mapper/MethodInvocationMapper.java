...
import org.jqassistant.contrib.plugin.javagen.api.model.MethodInvocation;
...
public interface MethodInvocationMapper {
    ...
    public static MethodInvocationMapper INSTANCE = Mappers.getMapper(MethodInvocationMapper.class);
