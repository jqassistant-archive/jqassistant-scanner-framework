...
import org.jqassistant.contrib.plugin.javagen.api.model.BasicForStatementNoShortIf;
...
public interface BasicForStatementNoShortIfMapper {

    public static BasicForStatementNoShortIfMapper INSTANCE = Mappers.getMapper(BasicForStatementNoShortIfMapper.class);
