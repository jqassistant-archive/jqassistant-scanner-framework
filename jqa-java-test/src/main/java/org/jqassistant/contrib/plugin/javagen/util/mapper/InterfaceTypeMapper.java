...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceType;
...
public interface InterfaceTypeMapper {
    ...
    public static InterfaceTypeMapper INSTANCE = Mappers.getMapper(InterfaceTypeMapper.class);
