...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeArgument;
...
public interface TypeArgumentMapper {

    public static TypeArgumentMapper INSTANCE = Mappers.getMapper(TypeArgumentMapper.class);
