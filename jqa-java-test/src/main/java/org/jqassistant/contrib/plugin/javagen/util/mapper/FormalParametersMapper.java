...
import org.jqassistant.contrib.plugin.javagen.api.model.FormalParameters;
...
public interface FormalParametersMapper {

    public static FormalParametersMapper INSTANCE = Mappers.getMapper(FormalParametersMapper.class);
