...
import org.jqassistant.contrib.plugin.javagen.api.model.Dims;
...
public interface DimsMapper {

    public static DimsMapper INSTANCE = Mappers.getMapper(DimsMapper.class);
