...
import org.jqassistant.contrib.plugin.javagen.api.model.AnnotationTypeDeclaration;
...
public interface AnnotationTypeDeclarationMapper {

    public static AnnotationTypeDeclarationMapper INSTANCE = Mappers.getMapper(AnnotationTypeDeclarationMapper.class);
