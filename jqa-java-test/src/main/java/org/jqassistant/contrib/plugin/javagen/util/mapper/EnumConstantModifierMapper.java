...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumConstantModifier;
...
public interface EnumConstantModifierMapper {

    public static EnumConstantModifierMapper INSTANCE = Mappers.getMapper(EnumConstantModifierMapper.class);
