...
import org.jqassistant.contrib.plugin.javagen.api.model.SwitchBlockStatementGroup;
...
public interface SwitchBlockStatementGroupMapper {

    public static SwitchBlockStatementGroupMapper INSTANCE = Mappers.getMapper(SwitchBlockStatementGroupMapper.class);
