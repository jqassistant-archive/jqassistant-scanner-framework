...
import org.jqassistant.contrib.plugin.javagen.api.model.ConstructorDeclarator;
...
public interface ConstructorDeclaratorMapper {

    public static ConstructorDeclaratorMapper INSTANCE = Mappers.getMapper(ConstructorDeclaratorMapper.class);
