...
import org.jqassistant.contrib.plugin.javagen.api.model.ForStatementNoShortIf;
...
public interface ForStatementNoShortIfMapper {

    public static ForStatementNoShortIfMapper INSTANCE = Mappers.getMapper(ForStatementNoShortIfMapper.class);
