...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableModifier;
...
public interface VariableModifierMapper {

    public static VariableModifierMapper INSTANCE = Mappers.getMapper(VariableModifierMapper.class);
