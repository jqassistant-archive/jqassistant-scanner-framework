...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeDeclaration;
...
public interface TypeDeclarationMapper {

    public static TypeDeclarationMapper INSTANCE = Mappers.getMapper(TypeDeclarationMapper.class);
