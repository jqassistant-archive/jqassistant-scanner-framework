...
import org.jqassistant.contrib.plugin.javagen.api.model.ExtendsInterfaces;
...
public interface ExtendsInterfacesMapper {

    public static ExtendsInterfacesMapper INSTANCE = Mappers.getMapper(ExtendsInterfacesMapper.class);
