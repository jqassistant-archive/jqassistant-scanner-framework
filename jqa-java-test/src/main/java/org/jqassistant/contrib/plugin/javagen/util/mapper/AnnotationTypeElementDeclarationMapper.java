...
import org.jqassistant.contrib.plugin.javagen.api.model.AnnotationTypeElementDeclaration;
...
public interface AnnotationTypeElementDeclarationMapper {

    public static AnnotationTypeElementDeclarationMapper INSTANCE = Mappers.getMapper(AnnotationTypeElementDeclarationMapper.class);
