...
import org.jqassistant.contrib.plugin.javagen.api.model.ClassInstanceCreationExpression;
...
public interface ClassInstanceCreationExpressionMapper {

    public static ClassInstanceCreationExpressionMapper INSTANCE = Mappers.getMapper(ClassInstanceCreationExpressionMapper.class);
