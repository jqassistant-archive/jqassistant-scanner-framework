...
import org.jqassistant.contrib.plugin.javagen.api.model.StaticInitializer;
...
public interface StaticInitializerMapper {

    public static StaticInitializerMapper INSTANCE = Mappers.getMapper(StaticInitializerMapper.class);
