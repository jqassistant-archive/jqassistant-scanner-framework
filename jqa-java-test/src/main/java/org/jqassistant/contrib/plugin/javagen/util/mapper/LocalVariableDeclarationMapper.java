...
import org.jqassistant.contrib.plugin.javagen.api.model.LocalVariableDeclaration;
...
public interface LocalVariableDeclarationMapper {

    public static LocalVariableDeclarationMapper INSTANCE = Mappers.getMapper(LocalVariableDeclarationMapper.class);
