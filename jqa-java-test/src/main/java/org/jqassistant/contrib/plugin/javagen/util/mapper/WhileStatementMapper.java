...
import org.jqassistant.contrib.plugin.javagen.api.model.WhileStatement;
...
public interface WhileStatementMapper {

    public static WhileStatementMapper INSTANCE = Mappers.getMapper(WhileStatementMapper.class);
