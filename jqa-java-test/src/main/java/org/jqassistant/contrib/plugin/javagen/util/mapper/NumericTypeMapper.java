...
import org.jqassistant.contrib.plugin.javagen.api.model.NumericType;
...
public interface NumericTypeMapper {

    public static NumericTypeMapper INSTANCE = Mappers.getMapper(NumericTypeMapper.class);
