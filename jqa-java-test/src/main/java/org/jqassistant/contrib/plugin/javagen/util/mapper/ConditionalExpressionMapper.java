...
import org.jqassistant.contrib.plugin.javagen.api.model.ConditionalExpression;
...
public interface ConditionalExpressionMapper {
    ...
    public static ConditionalExpressionMapper INSTANCE = Mappers.getMapper(ConditionalExpressionMapper.class);
