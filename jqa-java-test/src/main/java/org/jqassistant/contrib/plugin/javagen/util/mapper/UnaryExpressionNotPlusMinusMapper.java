...
import org.jqassistant.contrib.plugin.javagen.api.model.UnaryExpressionNotPlusMinus;
...
public interface UnaryExpressionNotPlusMinusMapper {

    public static UnaryExpressionNotPlusMinusMapper INSTANCE = Mappers.getMapper(UnaryExpressionNotPlusMinusMapper.class);
