...
import org.jqassistant.contrib.plugin.javagen.api.model.PackageDeclaration;
...
public interface PackageDeclarationMapper {

    public static PackageDeclarationMapper INSTANCE = Mappers.getMapper(PackageDeclarationMapper.class);
