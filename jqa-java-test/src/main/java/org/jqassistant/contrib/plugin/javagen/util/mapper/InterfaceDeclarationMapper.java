...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceDeclaration;
...
public interface InterfaceDeclarationMapper {

    public static InterfaceDeclarationMapper INSTANCE = Mappers.getMapper(InterfaceDeclarationMapper.class);
