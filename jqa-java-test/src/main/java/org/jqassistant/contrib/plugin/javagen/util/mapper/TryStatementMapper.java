...
import org.jqassistant.contrib.plugin.javagen.api.model.TryStatement;
...
public interface TryStatementMapper {

    public static TryStatementMapper INSTANCE = Mappers.getMapper(TryStatementMapper.class);
