...
public interface CommonMappingConfig {
    ...
    org.jqassistant.contrib.plugin.javagen.api.JavaGenAST map(@Context() FileResource item, @Context() ScannerContext scannerContext, ParserRuleContext parserContext);
}
