...
import org.jqassistant.contrib.plugin.javagen.api.model.PackageModifier;
...
public interface PackageModifierMapper {

    public static PackageModifierMapper INSTANCE = Mappers.getMapper(PackageModifierMapper.class);
