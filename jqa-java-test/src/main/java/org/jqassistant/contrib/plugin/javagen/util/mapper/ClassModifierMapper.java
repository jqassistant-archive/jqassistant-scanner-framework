...
import org.jqassistant.contrib.plugin.javagen.api.model.ClassModifier;
...
public interface ClassModifierMapper {

    public static ClassModifierMapper INSTANCE = Mappers.getMapper(ClassModifierMapper.class);
