...
import org.jqassistant.contrib.plugin.javagen.api.model.Superinterfaces;
...
public interface SuperinterfacesMapper {

    public static SuperinterfacesMapper INSTANCE = Mappers.getMapper(SuperinterfacesMapper.class);
