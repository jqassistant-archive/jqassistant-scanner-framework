...
import org.jqassistant.contrib.plugin.javagen.api.model.StatementExpression;
...
public interface StatementExpressionMapper {

    public static StatementExpressionMapper INSTANCE = Mappers.getMapper(StatementExpressionMapper.class);
