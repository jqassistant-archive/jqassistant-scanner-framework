...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceBody;
...
public interface InterfaceBodyMapper {

    public static InterfaceBodyMapper INSTANCE = Mappers.getMapper(InterfaceBodyMapper.class);
