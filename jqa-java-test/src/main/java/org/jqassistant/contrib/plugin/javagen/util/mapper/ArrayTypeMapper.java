...
import org.jqassistant.contrib.plugin.javagen.api.model.ArrayType;
...
public interface ArrayTypeMapper {

    public static ArrayTypeMapper INSTANCE = Mappers.getMapper(ArrayTypeMapper.class);
