...
import org.jqassistant.contrib.plugin.javagen.api.model.TryWithResourcesStatement;
...
public interface TryWithResourcesStatementMapper {

    public static TryWithResourcesStatementMapper INSTANCE = Mappers.getMapper(TryWithResourcesStatementMapper.class);
