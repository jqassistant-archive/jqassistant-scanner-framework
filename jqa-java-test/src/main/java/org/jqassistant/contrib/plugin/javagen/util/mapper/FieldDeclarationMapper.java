...
import org.jqassistant.contrib.plugin.javagen.api.model.FieldDeclaration;
...
public interface FieldDeclarationMapper {

    public static FieldDeclarationMapper INSTANCE = Mappers.getMapper(FieldDeclarationMapper.class);
