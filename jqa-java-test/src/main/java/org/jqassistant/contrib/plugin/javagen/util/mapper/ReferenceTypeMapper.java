...
import org.jqassistant.contrib.plugin.javagen.api.model.ReferenceType;
...
public interface ReferenceTypeMapper {
    ...
    public static ReferenceTypeMapper INSTANCE = Mappers.getMapper(ReferenceTypeMapper.class);
