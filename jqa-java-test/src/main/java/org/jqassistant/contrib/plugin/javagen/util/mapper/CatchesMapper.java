...
import org.jqassistant.contrib.plugin.javagen.api.model.Catches;
...
public interface CatchesMapper {

    public static CatchesMapper INSTANCE = Mappers.getMapper(CatchesMapper.class);
