...
import org.jqassistant.contrib.plugin.javagen.api.model.CatchClause;
...
public interface CatchClauseMapper {

    public static CatchClauseMapper INSTANCE = Mappers.getMapper(CatchClauseMapper.class);
