...
import org.jqassistant.contrib.plugin.javagen.api.model.UnannType;
...
public interface UnannTypeMapper {

    public static UnannTypeMapper INSTANCE = Mappers.getMapper(UnannTypeMapper.class);
