...
import org.jqassistant.contrib.plugin.javagen.api.model.IfThenElseStatement;
...
public interface IfThenElseStatementMapper {

    public static IfThenElseStatementMapper INSTANCE = Mappers.getMapper(IfThenElseStatementMapper.class);
