...
import org.jqassistant.contrib.plugin.javagen.api.model.PostDecrementExpression;
...
public interface PostDecrementExpressionMapper {

    public static PostDecrementExpressionMapper INSTANCE = Mappers.getMapper(PostDecrementExpressionMapper.class);
