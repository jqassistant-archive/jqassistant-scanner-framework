...
import org.jqassistant.contrib.plugin.javagen.api.model.FormalParameter;
...
public interface FormalParameterMapper {

    public static FormalParameterMapper INSTANCE = Mappers.getMapper(FormalParameterMapper.class);
