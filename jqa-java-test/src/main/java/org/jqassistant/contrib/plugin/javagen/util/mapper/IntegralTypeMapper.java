...
import org.jqassistant.contrib.plugin.javagen.api.model.IntegralType;
...
public interface IntegralTypeMapper {
    ...
    public static IntegralTypeMapper INSTANCE = Mappers.getMapper(IntegralTypeMapper.class);
