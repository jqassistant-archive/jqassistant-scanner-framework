...
import org.jqassistant.contrib.plugin.javagen.api.model.VariableInitializer;
...
public interface VariableInitializerMapper {

    public static VariableInitializerMapper INSTANCE = Mappers.getMapper(VariableInitializerMapper.class);
