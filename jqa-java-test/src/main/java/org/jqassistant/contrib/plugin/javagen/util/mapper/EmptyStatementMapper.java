...
import org.jqassistant.contrib.plugin.javagen.api.model.EmptyStatement;
...
public interface EmptyStatementMapper {
    ...
    public static EmptyStatementMapper INSTANCE = Mappers.getMapper(EmptyStatementMapper.class);
