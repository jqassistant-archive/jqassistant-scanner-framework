...
import org.jqassistant.contrib.plugin.javagen.api.model.LabeledStatement;
...
public interface LabeledStatementMapper {
    ...
    public static LabeledStatementMapper INSTANCE = Mappers.getMapper(LabeledStatementMapper.class);
