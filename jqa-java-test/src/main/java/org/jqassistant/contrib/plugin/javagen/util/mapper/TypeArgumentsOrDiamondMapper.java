...
import org.jqassistant.contrib.plugin.javagen.api.model.TypeArgumentsOrDiamond;
...
public interface TypeArgumentsOrDiamondMapper {

    public static TypeArgumentsOrDiamondMapper INSTANCE = Mappers.getMapper(TypeArgumentsOrDiamondMapper.class);
