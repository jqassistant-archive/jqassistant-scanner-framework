...
import org.jqassistant.contrib.plugin.javagen.api.model.ElementValueList;
...
public interface ElementValueListMapper {

    public static ElementValueListMapper INSTANCE = Mappers.getMapper(ElementValueListMapper.class);
