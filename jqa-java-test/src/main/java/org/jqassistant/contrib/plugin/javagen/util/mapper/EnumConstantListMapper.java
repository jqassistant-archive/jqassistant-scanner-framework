...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumConstantList;
...
public interface EnumConstantListMapper {

    public static EnumConstantListMapper INSTANCE = Mappers.getMapper(EnumConstantListMapper.class);
