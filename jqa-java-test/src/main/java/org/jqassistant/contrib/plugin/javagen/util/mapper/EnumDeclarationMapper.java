...
import org.jqassistant.contrib.plugin.javagen.api.model.EnumDeclaration;
...
public interface EnumDeclarationMapper {

    public static EnumDeclarationMapper INSTANCE = Mappers.getMapper(EnumDeclarationMapper.class);
