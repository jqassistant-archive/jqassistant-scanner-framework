...
import org.jqassistant.contrib.plugin.javagen.api.model.ElementValueArrayInitializer;
...
public interface ElementValueArrayInitializerMapper {

    public static ElementValueArrayInitializerMapper INSTANCE = Mappers.getMapper(ElementValueArrayInitializerMapper.class);
