...
import org.jqassistant.contrib.plugin.javagen.api.model.InterfaceTypeList;
...
public interface InterfaceTypeListMapper {

    public static InterfaceTypeListMapper INSTANCE = Mappers.getMapper(InterfaceTypeListMapper.class);
