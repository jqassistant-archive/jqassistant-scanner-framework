...
import org.jqassistant.contrib.plugin.javagen.api.model.WhileStatementNoShortIf;
...
public interface WhileStatementNoShortIfMapper {

    public static WhileStatementNoShortIfMapper INSTANCE = Mappers.getMapper(WhileStatementNoShortIfMapper.class);
